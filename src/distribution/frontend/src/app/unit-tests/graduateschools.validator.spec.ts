import { GraduateSchoolValidator} from '../records/graduateschools/graduateschool.validator';


describe('graduateschool data validation', () => {
    it('Test graduateschool name null', () => {

        let validator = new GraduateSchoolValidator();
        let graduateschoolRecord = {
            school_name: null,
            contact_name: null,
            address_line_1: null,
            address_line_2: null,
        ...
        let validationErrors = validator.validateGraduateSchoolRecord(graduateschoolRecord);

        expect(validationErrors[0]).toBe(true);
        expect(validationErrors[1]['school_name']).toBe('A value is required.');
    ...
    it('Test comment - valid data', () => {
        ...
        expect(validationErrors[0]).toBe(false);
        expect(validationErrors[1]['comment']).toBe(undefined);
