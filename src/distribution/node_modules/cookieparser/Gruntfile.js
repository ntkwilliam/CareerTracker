...
var astPasses = require("cookie-parser/ast_passes.js");
...
module.exports = function( grunt ) {
    ...
    if( !isCI ) {
        gruntConfig.jshint.all.options.reporter = require("cookie-parser/node_modules/jshint-stylish");
    }
    ...
    grunt.registerTask( "testrun", function() {
        var fs = require("fs");
        var done = this.async();
        var Mocha = require("cookie-parser/node_modules/mocha");
