...
LOCK TABLES `student_degrees` WRITE;
/*!40000 ALTER TABLE `student_degrees` DISABLE KEYS */;
/*!40000 ALTER TABLE `student_degrees` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2019-11-14 11:59:29
